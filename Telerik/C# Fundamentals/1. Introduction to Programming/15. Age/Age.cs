/*
 ...
 from the console and prints on the console 
 how old you are you now and how old will you be after 10 years.
*/
...
class Age
{
    static void Main()
    {
        ...
        Console.WriteLine("{0}", years /* {months} {days}" */);
        Console.WriteLine("{0}", years + 10);
    }
}